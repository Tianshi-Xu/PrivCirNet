...
# cvt SpENCNN, pruning
CUDA_VISIBLE_DEVICES=5 python train_prune.py -c configs/datasets/Prune/CVT/cifar10.yml --model cvt_7_4_32 /home/xts/code/dataset/cifar10/

CUDA_VISIBLE_DEVICES=5 python train_prune.py -c configs/datasets/Prune/CVT/cifar100.yml --model cvt_7_4_32_c100 /home/xts/code/dataset/cifar100/

CUDA_VISIBLE_DEVICES=6 python train_prune.py -c configs/datasets/Prune/CVT/tiny.yml --model cvt_9_12_64 /home/xts/code/dataset/tiny-imagenet-200/