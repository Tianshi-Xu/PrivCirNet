...
CUDA_VISIBLE_DEVICES=5 python train_cir.py -c configs/datasets/MBV2/cifar100_fix.yml --model c100_cir_mobilenetv2 /home/xts/code/dataset/cifar100/
...
CUDA_VISIBLE_DEVICES=3 python train_cir.py -c configs/datasets/ViT/cifar100_fix.yml --model vit_7_4_32_c100 /home/xts/code/dataset/cifar100/
