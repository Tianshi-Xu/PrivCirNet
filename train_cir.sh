...
# resnet fix
CUDA_VISIBLE_DEVICES=6 python train_cir.py -c configs/datasets/ResNet/cifar10_fix.yml --model cir_cifar10_resnet18 /home/xts/code/dataset/cifar10/
...
CUDA_VISIBLE_DEVICES=7 python train_cir.py -c configs/datasets/ResNet/tiny_fix.yml --model cir_tiny_resnet18 /home/xts/code/dataset/tiny-imagenet-200/
...
CUDA_VISIBLE_DEVICES=5 python train_cir.py -c configs/datasets/ViT/tiny_fix.yml --model vit_9_12_64 /home/xts/code/dataset/tiny-imagenet-200/
