...
# resnet fix
CUDA_VISIBLE_DEVICES=0 python train_cir.py -c configs/datasets/ResNet/cifar10_fix.yml --model cir_cifar10_resnet18 /home/xts/code/dataset/cifar10/
CUDA_VISIBLE_DEVICES=0 python train_cir.py -c configs/datasets/ResNet/cifar100_fix.yml --model cir_cifar100_resnet18 /home/xts/code/dataset/cifar100/
