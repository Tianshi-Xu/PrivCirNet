...
# resnet18
CUDA_VISIBLE_DEVICES=1 python train.py -c configs/datasets/ConvNets/cifar10.yml --model cifar10_resnet18 /home/xts/code/dataset/cifar10/
CUDA_VISIBLE_DEVICES=2 python train.py -c configs/datasets/ConvNets/cifar100.yml --model cifar100_resnet18 /home/xts/code/dataset/cifar100/
CUDA_VISIBLE_DEVICES=7 python train.py -c configs/datasets/ConvNets/tiny.yml --model tiny_resnet18 /home/xts/code/dataset/tiny-imagenet-200/
